...
public final class ChatWithFriend extends JFrame {
	...
	private void init() {
		...
		showPanel.getVerticalScrollBar().setUI(new com.chat.frame.ScrollBarUI());
		...
		inputScroll.getVerticalScrollBar().setUI(new com.chat.frame.ScrollBarUI());
		...
		if (isGroup) {
			...
			groupPeopleScrollPanel.getVerticalScrollBar().setUI(new com.chat.frame.ScrollBarUI());
